        ...
        <ul className="space-y-1">
          <li>
            <label className="flex items-center">
              ...
              />
              <span className="ms-1.5 text-sm">{t("common:free-cancel")}</span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
          ...
          <li>
            <label className="flex items-center">
              ...
              />
              <span className="ms-1.5 text-sm">
                {t("common:special-offer-building")}
              </span>
            </label>
          </li>
        </ul>
          ...
          <li className="flex justify-between items-center gap-2">
            <label className="flex items-center">
              <input
                ...
                className="form-checkbox outline-none text-primary ring-0 ring-offset-0 rounded checked:ring-primary ring-dark h-3 w-3 "
              />
              <span className="ms-1.5 text-sm">{t("common:4-stars")}</span>
            </label>
          </li>
          <li className="flex justify-between items-center gap-2">
            <label className="flex items-center">
              <input
                ...
                className="form-checkbox outline-none text-primary ring-0 ring-offset-0 rounded checked:ring-primary ring-dark h-3 w-3 "
              />
              <span className="ms-1.5 text-sm">{t("common:5-stars")}</span>
            </label>
          </li>
        </ul>
      </div>
        ...
        <ul className="space-y-1">
          <li className="flex justify-between items-center gap-2">
            <label className="flex items-center">
              <input
                ...
                className="form-checkbox outline-none text-primary ring-0 ring-offset-0 rounded checked:ring-primary ring-dark h-3 w-3 "
              />
              <span className="ms-1.5 text-sm">{t("common:hotels")}</span>
            </label>
          </li>
          <li className="flex justify-between items-center gap-2">
            <label className="flex items-center">
          ...
          <li className="flex justify-between items-center gap-2">
            <label className="flex items-center">
              ...
              <span className="ms-1.5 text-sm">
                {" "}
                {t("common:small-hotels-for-teenagers")}
              </span>
            </label>
          </li>
          <Disclosure>
          ...
          <li className="flex justify-between items-center gap-2">
            <label className="flex items-center">
              <input
                ...
                className="form-checkbox outline-none text-primary ring-0 ring-offset-0 rounded checked:ring-primary ring-dark h-3 w-3 "
              />
              <span className="ms-1.5 text-sm">{t("common:small-hotels-for-teenagers")}</span>
            </label>
          </li>
          <Disclosure>
            {({ open }) => (
